...
curl -X PUT -H "Content-Type: application/json;charset=utf-8" -d '/home/k8s-test/test-api/zk/zk.json' "http://172.30.10.122:8080/api/v1/namespaces/default/replicationcontrollers/ecnetwork-shop"
